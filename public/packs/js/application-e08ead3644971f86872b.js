...
$(document).on('turbolinks:load', function () {
  ...
  $('form > input').on('keyup', function () {
    ...
    if (empty) {
      $('#item-submit').attr('disabled', 'disabled'); // updated according to http://stackoverflow.com/questions/7637790/how-to-remove-disabled-attribute-with-jquery-ie
    } else {
      $('#item-submit').removeAttr('disabled'); // updated according to http://stackoverflow.com/questions/7637790/how-to-remove-disabled-attribute-with-jquery-ie
    }
  });
});
...
/******/ });
//# sourceMappingURL=application-e08ead3644971f86872b.js.map