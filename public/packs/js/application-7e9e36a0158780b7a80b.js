...
$(document).on('turbolinks:load', function () {
  ...
  $('.delete').on('mouseenter', function (event) {
    $(event.currentTarget).addClass('delete-hover');
    $(event.currentTarget).removeClass('delete-no-hover');
  });
  $('.delete').on('mouseleave', function (event) {
    $(event.currentTarget).addClass('delete-no-hover');
    $(event.currentTarget).removeClass('delete-hover');
  });
});
...
/******/ });
//# sourceMappingURL=application-7e9e36a0158780b7a80b.js.map